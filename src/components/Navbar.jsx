...
import { logo, menu, close, myResume } from "../assets";
      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          <img
            ...
            alt="menu"
            className="w-[28] h-[28] object-contain curser-pointer"
          ...
          {navLinks.map((link) => (
            ...
            <li
              key={link.id}
              className={`${active === link.title ? "text-white" : "text-secondary"} font-poppins font-medium curser-pointer text-[16px]`}
              onClick={() => 
                {
                  setToggle(!toggle);
